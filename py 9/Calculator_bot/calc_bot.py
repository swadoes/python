...
def start(update, _):
    update.message.reply_text(
        'Приветствую - это только калькулятор. Введите с какими числами хоитите сделать операцию.\n'
...
def complex_one(update, context):
    ...
    if ' ' in test and (test.replace(' ', '')).isdigit():
        ...
        update.message.reply_text(
            'Это не то. Введите Re и Im первого числа через ПРОБЕЛ')
...
def complex_two(update, context):
    ...
    if ' ' in test and (test.replace(' ', '')).isdigit():
        ...
        update.message.reply_text(
            'Это не то. Введите Re и Im второго числа через ПРОБЕЛ')
